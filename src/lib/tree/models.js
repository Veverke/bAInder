...
export class ChatEntry {
  ...
  validate() {
    ...
    if (!['chatgpt', 'claude', 'gemini', 'copilot', 'perplexity', 'deepseek'].includes(this.source)) {
      throw new Error('Chat must have a valid source (chatgpt, claude, gemini, copilot, perplexity, or deepseek)');
    }
    return true;
  }
